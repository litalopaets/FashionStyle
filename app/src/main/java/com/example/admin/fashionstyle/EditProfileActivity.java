...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void uploadImage(){
        ...
        if(mIamgeUri != null){
            final StorageReference filereference = storageRef.child(System.currentTimeMillis()+ "." + getFileExtenstion(mIamgeUri));

            uploadTask = filereference.putFile(mIamgeUri);
